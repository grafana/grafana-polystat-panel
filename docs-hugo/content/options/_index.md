...
title: Customization
params:
  menuPre: '<i class="fa fa-sliders" aria-hidden="true"></i> '
---
...
![Auto Layout](/images/options/polystat-v2-options-layout.png)
...
![Manual Layout](/images/options/polystat-v2-layout-manual.png)

If there are not enough columns and rows to display all of the data, a warning is displayed.

![Manual Layout Warning](/images/options/polystat-v2-layout-warning.png)
...
![Polygon Sizing](/images/options/polystat-v2-sizing-auto.png)

You can also set a border on each polygon. The default value is 2 pixels.

![Polygon Border Sizing](/images/options/polystat-v2-sizing-manual.png)
...
![Polygon Auto Text Font Size](/images/options/polystat-v2-text-auto-all.png)

Uncheck this option to manually enter a font size.

![Polygon Manual Text Font Size](/images/options/polystat-v2-text-manual-fontsize.png)
...
![Polygon Text Manual Font Color](/images/options/polystat-v2-text-manual-font-color.png)

You can manually set Font Color with the color picker.

![Polygon Text Font Manual Color Picker](/images/options/polystat-v2-text-font-color-picker.png)

### Sorting

Sorting allows you to set the order (left to right) of the displayed polygons.

![Sort Settings](/images/options/polystat-v2-sorting.png)

Supported directions:

![Sorting Directions](/images/options/polystat-v2-sorting-directions.png)

Supported fields:

![Sorting Fields](/images/options/polystat-v2-sorting-fields.png)

### Tooltips

![Tooltips](/images/options/polystat-v2-tooltips-all.png)
...
![Tooltip Display Modes](/images/options/polystat-v2-tooltips-display-modes.png)
...
![Tooltip Sort Directions](/images/options/polystat-v2-tooltips-sort-directions.png)
...
![Tooltip Sort By Field](/images/options/polystat-v2-tooltips-primary-sortby-field.png)
...
![Global Show Timestamp](/images/options/polystat-v2-global-showtimestamp.png)
...
![Global Show Timestamp Position Above](/images/options/polystat-v2-global-timestamp-above.png)

![Global Show Timestamp Position Below](/images/options/polystat-v2-global-timestamp-below.png)
