...
params:
  menuPre: '<i class="fa fa-tasks" aria-hidden="true"></i> '
---
...
![Global](/images/settings/polystat-v2-global-all.png)
...
- **Global Thresholds**: This set of thresholds are applied to all metrics that do not have a matching override. See [Use thresholds](/thresholds) for details on how thresholds are evaluated.

- **Global Clickthrough**: The clickthrough URL is applied to all polygons that do not have an override or composite with a clickthrough specified. See more at [Use Clickthroughs](/clickthroughurl).
...
![Polygon Shapes](/images/settings/polystat-v2-global-shapes.png)

**Hexagon Pointed Top**

![Polygon Hexagon Pointed Top](/images/settings/polystat-v2-shape-hexagon-pointed-top.png)

**Circle**

![Polygon Circle](/images/settings/polystat-v2-shape-circle.png)

**Square**

![Polygon Square](/images/settings/polystat-v2-shape-square.png)
...
![Before Aliasing](/images/settings/regex-alias-before.png)

If you add the regular expression `/(Foo|Bar)/`, the result is:

![After Aliasing](/images/settings/regex-alias-after.png)
