...
weight: 20
params:
  menuPre: '<i class="fa fa-object-group" aria-hidden="true"></i> '
---
...
![Composites Options All](/images/composites/polystat-v2-composites-all.png)

This is what two composites look like once they are rendered:

![Composite Rendered](/images/composites/polystat-v2-composite-rendered.png)

This is the tooltip that is displayed when hovering over the composite:

![Composite Rendered with Tooltip](/images/composites/polystat-v2-composite-with-tooltip.png)
...
![Animation Example](/images/composites/polystat-v2-composite-animated.gif)
...
![Custom URL Target](/images/composites/polystat-v2-custom-clickthrough-target.png)
...
![Composite Bottom Menu](/images/composites/polystat-v2-composite-bottom-menu.png)
...
![Composite Add Metric](/images/composites/polystat-v2-composite-add-metric.png)
