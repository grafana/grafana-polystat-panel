...
- **Thresholds**: An override can specify a set of thresholds that are to be applied to the matching metric, and will replace any global threshold settings. See Use thresholds for details on how thresholds are evaluated.
...
- **Clickthrough URL**: Use this setting to indicate the URL to open when clicking the polygon. See more at Use Clickthroughs.
